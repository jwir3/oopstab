...
var OopsTab = {
    ...
    startup: function() {
      ...
      Services.scriptloader.loadSubScript("chrome://oopstab/content/oopstab.js", {pref:prefLoader.setDefaultPref} );
    ...
    shutdown: function() {
      ...
      var prefLoader = require("./prefloader.js");
      this.consoleService.logStringMessage("Clearing pref branch");
